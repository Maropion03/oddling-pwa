  ...
  return (
    <main className="privacy-page">
      ...
      <article className="privacy-copy">
        ...
        <section><h2>保存什么</h2><p>分身外观、名字、性格属性、每日回答、变异、贴纸、公开分享记录，以及匿名账号会话。绑定邮箱后，邮箱只用于恢复账号。</p></section>
        <section><h2>公开什么</h2><p>公开链接只包含角色快照、名字、可公开的性格状态和你主动选择分享的贴纸。它不包含每日回答、邮箱或其他账号信息。公开链接默认 30 天后失效，也可以在“我的”中撤销。</p></section>
        <section><h2>模型调用</h2><p>如配置了 AI 生成服务，回答会用于生成角色化回应、贴纸文案和变异建议。服务不可用时，Oddling 使用本地规则引擎继续生成。</p></section>
        <section><h2>导出与删除</h2><p>你可以在“我的”中导出自己的数据，或删除全部数据。删除会同时移除云端匿名账户及其关联内容。</p></section>
